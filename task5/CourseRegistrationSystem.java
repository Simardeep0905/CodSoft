...
public class CourseRegistrationSystem {
    ...
    public static void main(String[] args) {
        ...
        system.addCourse(new Course("CS103", "Learn JAVA Programming", "Knowledge of Core Java programming", 100, "WFS 5-6PM"));
        system.addCourse(new Course("CS104", "Machine Learning", "Learn how to train robos", 100, "WFS 5-6PM"));
        
        // Adding some sample students
        system.addStudent(new Student("S001", "Ram"));
        system.addStudent(new Student("S002", "Isha"));
        system.addStudent(new Student("S003", "Simar"));
        system.addStudent(new Student("S005", "Gargi"));
        system.addStudent(new Student("S006", "Jiya"));
        system.addStudent(new Student("S007", "Manas"));
